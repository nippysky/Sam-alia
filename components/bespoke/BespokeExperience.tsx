...
const AREAS = [
  { id: "fabric", label: "Fabric Library", description: "Curated textiles" },
  { id: "fittings", label: "Fitting Session", description: "Precision tailoring" },
  { id: "lounge", label: "Lounge Suite", description: "Relaxed consultations" },
  { id: "ready", label: "Ready-to-Wear", description: "Timeless wardrobe" },
];
...
export function BespokeExperience() {
  return (
    <main className="relative min-h-screen w-full bg-black text-white">
      ...
      {/* Header (scroll-aware from your SiteHeader logic) */}
      <SiteHeader variant="transparent" />

      {/* Content */}
      <div className="relative z-20 px-5 sm:px-10 lg:px-20 pb-16 lg:pb-24">
        <div className="mx-auto flex min-h-[calc(100vh-80px)] max-w-5xl flex-col">
          {/* HERO BLOCK — centered on mobile, still cinematic on desktop */}
          <section className="flex min-h-[60vh] items-center justify-center">
            ...
            >
              ...
              <motion.p
                ...
                className="mt-4 max-w-xl text-sm leading-relaxed text-white/85 sm:text-[15px] mx-auto"
              >
          ...
          {/* GLASS CARDS — scrollable on mobile, full row on desktop */}
